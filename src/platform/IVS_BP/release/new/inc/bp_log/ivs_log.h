...
#ifdef WIN32
	#define BP_SFTP_KEY_CONFIG_FILE ("D:\\ivs\\TAU\\key.xml")
#else
	#define BP_SFTP_KEY_CONFIG_FILE ("/home/lib/key.xml")
#endif
//BP::CBPKeyConfig m_BPKeyConfig;										//密钥配置文件
...
//此处声明一个全局锁，用于防止ssl被重入（日志上传及onvif设备soap交互）而导致的崩溃， DTS2015120402556 
#ifndef WIN32
class CCryptoMutex
{
public:
...
public: 
	static CCryptoMutex instance;
	static pthread_mutex_t crypto_mutex;
};
#endif
