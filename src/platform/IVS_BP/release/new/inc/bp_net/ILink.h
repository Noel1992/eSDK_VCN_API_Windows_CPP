...
public:
    ...
    **************************************************************************/
	...
	void SetClientIPValidatedFlag(bool flag) {m_bIsClientIPValidated = flag;}
	bool GetClientIPValidatedFlag() {return m_bIsClientIPValidated;}
...
protected:
	...
	bool			 m_bIsClientIPValidated;		//客户端IP是否在白名单中
