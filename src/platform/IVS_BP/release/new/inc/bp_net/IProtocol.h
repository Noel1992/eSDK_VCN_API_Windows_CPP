...
public:
	...
	**************************************************************************/
    ...
    /**************************************************************************
	* name       : GetAuthKeyIv
	* description: 接入的keyIv
	* input      : NA
	* output     : NA
	* return     : const std::string& 
	* remark     : NA
	**************************************************************************/
    const std::string& GetAuthKeyIv() const { return(m_strAuthKeyIv); }

    /**************************************************************************
	* name       : SetAuthKeyIv
	* description: 设置协议接入秘钥（盐值）
	* input      : NA
	* output     : NA
	* return     : strAuthKey
	* remark     : NA
	**************************************************************************/
    void SetAuthKeyIv(const std::string& strAuthKeyIv) { m_strAuthKeyIv = strAuthKeyIv; }
