...
public:
    ...
    time_t GetTimestamp() const { return m_tTimestamp; }

    void SetTimestamp(time_t tTime) { m_tTimestamp = tTime; }
	...
	CCmd* NewClone()
	{
        ...
        pCmdClone->m_tTimestamp = m_tTimestamp;
...
private:
    ...
    CCmd& operator = (const CCmd& cmd)
    {
        ...
        this->m_tTimestamp = cmd.GetTimestamp();
