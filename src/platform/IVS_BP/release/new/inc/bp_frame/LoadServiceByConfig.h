...
private:
    ...
    * description: 从service.xml中获取线程堆栈大小，方便业务线程可配置
    * input      : NA
    * output     : NA
    * return     : 线程堆栈大小
    * remark     : NA    
    ...
    * remark     : NA    
    **************************************************************************/
	int CreateBusinessService(int iThreadNum, const std::string &strThreadName, bool bThreadConnectDatabase, int iCmdQueueLength, int iThreadStackSize=DEFAULT_THREAD_STACK_SIZE);
