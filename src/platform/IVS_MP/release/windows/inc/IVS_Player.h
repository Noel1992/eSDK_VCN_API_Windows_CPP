...
/*****************************************************************************
 ...
 返 回 值：成功:IVS_SUCCEED;失败:IVS_FAIL;
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __stdcall IVS_PLAY_SetDisplayFrameCallBack(IVS_ULONG ulChannel, DISPLAY_CALLBACK fnDisplayCB, void *pUser);
...
/*****************************************************************************
 函数名称：IVS_PLAY_SetVoiceSampleRate()
 功能描述：设置语音采样率
 输入参数：ulVoiceSampleRate             语音采样率
 输出参数：无
 返 回 值： ULONG
*****************************************************************************/
IVS_PLAYER_API IVS_INT32 __stdcall IVS_PLAY_SetVoiceSampleRate(IVS_ULONG ulVoiceSampleRate);
...
/*****************************************************************************
 函数名称：IVS_PLAY_SetZigZagFlag
 功能描述：设置是否需要进行Z行排序
 输入参数：NA
 输出参数：无
 返 回 值： IVS_VOID
*****************************************************************************/
IVS_PLAYER_API IVS_VOID __stdcall IVS_PLAY_SetZigZagFlag(IVS_ULONG ulChannel, bool bIsZigZag);
