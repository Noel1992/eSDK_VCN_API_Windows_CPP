...
// 定义特定的几个时间偏移量
#define OFFSET_BEGIN  (static_cast <unsigned int> (-3))  // 表示媒体最开始的位置
#define OFFSET_CUR    (static_cast <unsigned int> (-2))  // 表示媒体当前位置
#define OFFSET_END    (static_cast <unsigned int> (-1))  // 表示媒体结束位置
