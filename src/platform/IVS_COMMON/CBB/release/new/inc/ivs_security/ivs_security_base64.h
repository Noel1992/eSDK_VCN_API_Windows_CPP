...
public:
	...
	static void base64_decode(const unsigned char *data, unsigned int data_len,unsigned char *ret);
	static void base64_encode(const unsigned char* data, int data_len,unsigned char *ret);
};
