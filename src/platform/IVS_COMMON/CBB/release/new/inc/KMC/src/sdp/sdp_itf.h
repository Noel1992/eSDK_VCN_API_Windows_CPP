 ...
 *----------------------------------------------*/
/* 根据明文长度计算密文长度 */
KMC_API WSEC_ERR_T SDP_GetCipherDataLen(WSEC_UINT32 ulPlainTextLen, WSEC_UINT32* pulCipherLen);

/* 小数据加解密 */
KMC_API WSEC_ERR_T SDP_Encrypt(WSEC_UINT32 ulDomain,
                       const WSEC_BYTE *pucPlainText, WSEC_UINT32 ulPTLen,
                       WSEC_BYTE *pucCipherText, WSEC_UINT32 *pulCTLen);
KMC_API WSEC_ERR_T SDP_Decrypt(WSEC_UINT32 ulDomain,
