...
::平台路径名
set PlatformPath=%ProjectPath%\..\..\..\platform
::第三方工具的路径
set	ToolsPath=%ProjectPath%\..\..\..\tools
::测试demo的路径
set	TestDemoPath=%ProjectPath%\..\..\..\test\demo
::APIReadme的路径
set	APIReadmePath=%ProjectPath%\..
::OCXReadme的路径
set	OCXReadmePath=%ProjectPath%\build\windows\release\IVS_OCXPlayer
...
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\kmc.dll"					"tempversion\bin\"
...
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HW_ThirdParty\HIK\AnalyzeData.dll"	"tempversion\bin\HW_ThirdParty\HIK\"
...
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\svacdec.dll"				"tempversion\bin\"
...
@echo －－－－－－－－－－－－－－开始拷贝海康解码器依赖库－－－－－－－－－－－－－－－－	
@echo .
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCAlarm.dll" 				"tempversion\bin\HCNetSDKCom\"
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCCoreDevCfg.dll" 			"tempversion\bin\HCNetSDKCom\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCDisplay.dll" 			"tempversion\bin\HCNetSDKCom\"
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCGeneralCfgMgr.dll" 		"tempversion\bin\HCNetSDKCom\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCIndustry.dll" 			"tempversion\bin\HCNetSDKCom\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCPlayBack.dll" 			"tempversion\bin\HCNetSDKCom\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCPreview.dll" 			"tempversion\bin\HCNetSDKCom\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDKCom\HCVoiceTalk.dll" 			"tempversion\bin\HCNetSDKCom\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCCore.dll" 							"tempversion\bin\" 
xcopy /y /i /r /s "build\windows\release\IVS_SDK\bin\HCNetSDK.dll" 							"tempversion\bin\" 
...
xcopy /y /i /r /s "%PlatformPath%\IVS_COMMON\inc\hwsdk.h"	    	"tempversion\include\"
xcopy /y /i /r /s "%PlatformPath%\IVS_COMMON\inc\ivs_error.h"   		"tempversion\include\"
...
xcopy /y /i /r "%PlatformPath%\eSDKClientLogAPI\*.txt"	"tempversion\"
xcopy /y /i /r "%APIReadmePath%\readme.txt"	        	"tempversion\"
...
::拷贝OCX的日志上传统计模块配置文件
xcopy /E /y /i /r /s "%PlatformPath%\eSDKClientLogAPI\windows\WINOCXCfg\eSDKClientLogCfg.ini"	        	"tempcabversion\IVS_SDK\bin\"
...
::拷贝OCX的readme文件
xcopy /y /i /r "%OCXReadmePath%\readme.txt"	        	".\"
::拷贝日志搜集声明文件
xcopy /y /i /r "%PlatformPath%\eSDKClientLogAPI\*.txt"	".\"
::删除bs demo下的cab文件
del /Q "%TestDemoPath%\ivs_bs_demo\WebContent\ocx\*"
::拷贝cab文件到bs demo下
xcopy /y /i /r "IVS_OCX.cab"	                      "%TestDemoPath%\ivs_bs_demo\WebContent\ocx\"
...
cd ..\ivs_cs_demo_ocx\CSharp\eSDK_IVS_OCX_Demo_CSharp
