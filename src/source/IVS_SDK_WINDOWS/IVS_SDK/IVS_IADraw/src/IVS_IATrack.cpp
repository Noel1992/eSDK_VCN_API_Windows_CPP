...
LONG CIATrack::InsertIALayoutMessage(const IA_LAYOUT_MESSAGE *LayoutMessage)
{
	...
	eSDK_MEMSET(pInputLayoutMessage, 0, sizeof(IA_LAYOUT_MESSAGE));
	...
	eSDK_MEMSET(pROIMessage, 0, sizeof(IA_LAYOUT_MESSAGE));
...
{
    eSDK_MEMSET(&ArrowPointSet, 0, sizeof(ArrowPointSet));
