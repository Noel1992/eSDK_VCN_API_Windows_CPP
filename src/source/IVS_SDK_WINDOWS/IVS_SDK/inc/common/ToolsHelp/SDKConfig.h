...
public:
	...
	std::string GetNetSourceLogPath() { return m_NetSourceLogPath; }; //lint !e1036 !e1536

    void SetLogPath(std::string strLogPath) { m_LogPath = strLogPath; }; //lint !e1036 !e1536

	void SetNetSourceLogPath(std::string strLogPath) { m_NetSourceLogPath = strLogPath; }; //lint !e1036 !e1536
    ...
    *******************************************************************/
	...
	/******************************************************************
     ...
     return     : IVS_INT32
    *******************************************************************/
	IVS_BOOL GetTranslateConfig() const {return m_bIsTranslated;}

	/******************************************************************
     function   : SetTranslateConfig
     description: 加载配置文件
     output     : NA
     return     : IVS_INT32
    *******************************************************************/
    IVS_VOID SetTranslateConfig(IVS_BOOL bTranslateCfg) {m_bIsTranslated = bTranslateCfg;}
...
private:
    ...
    *******************************************************************/
	...
	/******************************************************************
     function   : SetNetSourceLogPath
     description: 设置NetSource日志路径
     input      : CBB::CXml& oCXml 配置文件CBB::CBB::CXml
     output     : NA
     return     : IVS_INT32
    *******************************************************************/
    IVS_INT32 SetNetSourceLogPath(CBB::CXml& oCXml);

	/******************************************************************
     function   : LoadTranslateConfig
     description: 加载TranslateConfig
     input      : CBB::CXml& oCXml 配置文件CBB::CBB::CXml
     output     : NA
     return     : IVS_INT32
    *******************************************************************/
    IVS_VOID LoadTranslateConfig(CBB::CXml& oCXml);
...
private:
	...
	std::string m_NetSourceLogPath;			// NetSource日志根路径
	bool bInit;
	...
	IVS_BOOL m_bIsTranslated;				// 是否转UTF-8到ANSI
