...
long CSynchronized::start()
{
    ...
    eSDK_MEMSET(&monitor, 0, sizeof(monitor));
    ...
    eSDK_MEMSET(&push_monitor, 0, sizeof(push_monitor));
    ...
    eSDK_MEMSET(&pop_cond, 0, sizeof(pop_cond));
    ...
    eSDK_MEMSET(&push_cond, 0, sizeof(push_cond));
