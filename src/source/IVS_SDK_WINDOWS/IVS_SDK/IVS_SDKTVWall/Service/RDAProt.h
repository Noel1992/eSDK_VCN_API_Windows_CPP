...
#define RDA_MSG_NAME_REINIT_BUSINESS_REQ "RDAReInitBusinessReq"
#define RDA_MSG_NAME_REINIT_BUSINESS_RSP "RDAReInitBusinessRsp"
#define RDA_MSG_NAME_RESTART_BUSINESS_REQ "RDAReStartBusinessReq"
#define RDA_MSG_NAME_RESTART_BUSINESS_RSP "RDAReStartBusinessRsp"
...
enum RDAMsgType
{
	...
	RDA_REINIT_BUSINESS_REQ = 0x000C, //主控重新初始化远程解码业务请求消息
	RDA_REINIT_BUSINESS_RSP = 0x100C, //主控重新初始化远程解码业务响应消息

	RDA_RESTART_BUSINESS_REQ = 0x000D, //主控通知重新启动远程解码业务
	RDA_RESTART_BUSINESS_RSP = 0x100D,

	RDA_CAPABILITY_REPORT_REQ = 0x000F, //硬解码器能力上报请求消息
	RDA_CAPABILITY_REPORT_RSP = 0x100F,	//硬解码器能力上报响应消息
};
...
/* 解码重新初始化消息 */
class CRDAReInitBusinessReq : public CRDAMsg
{
public:
    CRDAReInitBusinessReq( );
    ~CRDAReInitBusinessReq( ){};
public:
    RDA_UINT4 m_ulBusinessID;					//业务ID
    RDA_STRING_ID m_szDecoderID;			//解码器ID（20位，不包括\0）
...
/* 解码重新初始化响应消息 */
class CRDAReInitBusinessRsp : public CRDAMsg
{
public:
    CRDAReInitBusinessRsp();
    ~CRDAReInitBusinessRsp(){};
...
/* 重新启动音视频解码消息 */
class CRDAReStartBusinessReq : public CRDAMsg
{
public:
    CRDAReStartBusinessReq( );
    ~CRDAReStartBusinessReq( ){};
public:
    RDA_UINT4 m_ulBusinessID; //业务ID
    RDA_STRING_ID m_szDecoderID;  //解码器ID（20位，不包括\0）
...
/* 重新启动解码消息的响应消息 */
class CRDAReStartBusinessRsp : public CRDAMsg
{
public:
    CRDAReStartBusinessRsp();
    ~CRDAReStartBusinessRsp(){};
public:
    RDA_STRING_ID m_szDecoderID; //解码器ID（20位，不包括\0）
    RDA_UINT4 m_ulErrorCode; //返回码，0代表成功
...
/* 错误上报消息 */
class CRDACapabilityNotifyReq : public CRDAMsg
{
public:
    CRDACapabilityNotifyReq( );
    ~CRDACapabilityNotifyReq( ){};
public:
    RDA_STRING_ID m_szDecoderID; //解码器ID（20位，不包括\0）
    RDA_UINT4 m_ulSupportSwitch; //返回码，0代表成功
protected:
