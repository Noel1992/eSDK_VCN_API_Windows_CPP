...
public:
    ...
    * description: 处理重新初始化解码器消息
    * input      : objBusiness     业务对象引用
    * output     : NA
    * return     : long 错误码
    * remark     : NA
    **************************************************************************/
    IVS_INT32         HandleEventReIniBusiness(BUSINESS_ASYNC_INFO& stAsyncInfo);
    ...
    * description: 处理重新启动解码器消息
    * input      : objBusiness     业务对象引用
    * output     : NA
    * return     : long 错误码
    * remark     : NA
    **************************************************************************/
    IVS_INT32         HandleEventReStartBusiness(BUSINESS_ASYNC_INFO& stAsyncInfo);
