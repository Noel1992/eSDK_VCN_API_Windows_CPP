...
//转发域扩展
typedef std::list<IVS_DOMAIN_ROUTE_EX*> DOMAIN_CODE_LIST_EX;
typedef DOMAIN_CODE_LIST_EX::iterator DOMAIN_CODE_LIST_EX_ITER;
...
public:
    ...
    *******************************************************************/
	...
	/******************************************************************
    function : GetDomainRouteEx
    description: 查询域路由(转发域扩展)
    input : IVS_UINT32 uiBufferSize
    output : IVS_DOMAIN_ROUTE_LIST_EX * pDomainRouteList
    return : IVS_INT32
    *******************************************************************/
    IVS_INT32 GetDomainRouteEx(IVS_DOMAIN_ROUTE_LIST_EX* pDomainRouteList, IVS_UINT32 uiBufferSize );
	...
	*******************************************************************/
	...
	/******************************************************************
	 function   : GeDomainRouteParseXMLEx
	 description:  解析获取域路由响应(转发域扩展)
	 input      : IVS_DOMAIN_ROUTE_LIST_EX * pDomainRouteList
	 input      : CXml & xmlRsp
	 output     : NA
	 return     : IVS_INT32
	*******************************************************************/
	IVS_INT32 GeDomainRouteParseXMLEx( IVS_DOMAIN_ROUTE_LIST_EX* pDomainRouteList, CXml &xmlRsp);
...
private:
	...
	*******************************************************************/
	...
	/******************************************************************
	 function   : GetDomainRouteToListParseXMLEx
	 description: 解析域路由到List
	 input      : DOMAIN_CODE_LIST_EX & codeInfoList
	 input      : CXml & xmlRsp
	 output     : NA
	 return     : IVS_INT32
	*******************************************************************/
	IVS_INT32 GetDomainRouteToListParseXMLEx(DOMAIN_CODE_LIST_EX& codeInfoList, CXml &xmlRsp);
