...
public:
    ...
    static IVS_INT32 GetRoleListParseXML(CXml &xml, const IVS_INDEX_RANGE* pIndexRange, IVS_ROLE_INFO_LIST* pRoleList);
   ...
   *******************************************************************/   
   ...
   return			: 成功返回0，失败返回负数错误码
   *******************************************************************/   
	static IVS_INT32 ShutdownStreamByUserGetXML(const IVS_CHAR* pUserDomainCode,
		IVS_UINT32 uiUserID, 
		const IVS_CHAR* pCameraCode,
