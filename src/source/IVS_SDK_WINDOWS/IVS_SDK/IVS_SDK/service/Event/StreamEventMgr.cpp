...
int CStreamEventMgr::PostEvent(int iSessionID, unsigned long ulPlayHandle, int iBufferState)
{
    ...
    eSDK_MEMSET(pstEventData, 0, sizeof(STREAM_EVENT_DATA));
    ...
    {
        STREAM_EVENT_DATA* pstEventDataFront = m_eventQueue.front();//lint !e64 匹配
...
STREAM_EVENT_DATA* CStreamEventMgr::PopEvent()
{
    ...
    STREAM_EVENT_DATA* pstEventData = m_eventQueue.front();//lint !e64 匹配
    m_eventQueue.pop();
    return pstEventData;
}
...
{
    return PlayerEventCallback;//lint !e64 匹配
}
