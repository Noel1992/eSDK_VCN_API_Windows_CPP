...
//			eSDK_MEMSET(pInfo, 0, sizeof(SDK_DECODER_INFO));
...
IVS_VOID  CSDKDecoderMgr::LoginToDecoder()
{
	...
	//				eSDK_MEMSET(pstNotifyInfo, 0, sizeof(CUMW_NOTIFY_INFO));
	//				CUMW_NOTIFY_REMOTE_DECODER_STATUS* pstRegInfo = IVS_NEW(pstRegInfo);
	//				eSDK_MEMSET(pstRegInfo, 0, sizeof(CUMW_NOTIFY_REMOTE_DECODER_STATUS));
