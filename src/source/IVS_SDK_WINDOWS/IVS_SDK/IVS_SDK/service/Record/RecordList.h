...
typedef std::list<RECORD_DATA_PLACE> RecordDataPlaceList;
typedef RecordDataPlaceList::iterator RecordDataPlaceListIter;
...
public:
    ...
    ***********************************************************************************/
	...
	IVS_INT32 QueryRecordListByChannel(IVS_INT32 uiChannel, IVS_QUERY_UNIFIED_FORMAT* pUnifiedQuery, 
    ...
    ***********************************************************************************/
	...
	IVS_INT32 GetRecordListByChannel(IVS_INT32 uiChannel,IVS_INT32 iRecordMethod,const IVS_TIME_SPAN* pTimeSpan,
		const IVS_INDEX_RANGE* pIndexRange,IVS_RECORD_INFO_LIST* pRecordList,IVS_UINT32 uiBufSize);
    ...
    ***********************************************************************************/
    ...
    IVS_INT32 GetVildRecodList(const IVS_CHAR* pCameraCode, const IVS_INT32 iStarTime, const IVS_INT32 iEndTime, RecordDataPlaceList& VildRecodList);
