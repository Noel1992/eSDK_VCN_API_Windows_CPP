...
class CUserMgr;
class CDeviceUserListReqItem
{
public:
	std::string strDeviceUserGroupIDs;
	int iFromIndex;
	time_t tCreateTime;
	CDeviceUserListReqItem(void);
};
