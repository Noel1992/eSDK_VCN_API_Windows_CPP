...
public:
	...
	*******************************************************************/
	...
	IVS_INT32 StartPlatformPlayBackByChannel(IVS_UINT32 uiChannel,
		const IVS_PLAYBACK_PARAM* pPlaybackParam,
		HWND hWnd,
		IVS_ULONG* pHandle);
	...
	IVS_INT32 StartPlatformPlayBackCBByChannel(IVS_UINT32 uiChannel,
		const IVS_PLAYBACK_PARAM* pPlaybackParam,
		PlayBackCallBackRaw fPlayBackCallBackRaw,
		void* pUserData, 
		IVS_ULONG* pHandle);
	...
	IVS_INT32 StartPlatformPlayBackCBFrameByChannel(IVS_UINT32 uiChannel,
		const IVS_PLAYBACK_PARAM* pPlaybackParam,
		PlayBackCallBackFrame fPlayBackCallBackFrame,
		void* pUserData, 
		IVS_ULONG* pHandle);
...
#ifdef R5C20SPC100
	IVS_INT32 StartPlatformPlayBackCBFrameEx(const IVS_CHAR* pCameraCode,
		const IVS_PLAYBACK_PARAM* pPlaybackParam,
	...
	*******************************************************************/
	...
	return : 成功-0；失败-1
	*******************************************************************/
    IVS_INT32 StartPUPlayBackCBRaw(const IVS_CHAR* pCameraCode,
                              const IVS_PLAYBACK_PARAM* pPlaybackParam,
							  PlayBackCallBackRaw fPlayBackCallBackRaw,
							  void* pUserData, 
                              IVS_ULONG* pHandle);

	IVS_INT32 StartPUPlayBackByChannel(IVS_INT32 uiChannel,
		const IVS_PLAYBACK_PARAM* pPlaybackParam,
		HWND hWnd,
		IVS_ULONG* pHandle);
	...
	*******************************************************************/
    ...
    IVS_INT32 GetStreamID(IVS_ULONG ulHandle, char* pszBuf, unsigned int uiBufLen);
	...
	****************************************************************************/
	...
	/******************************************************************
	function			: EnablePUPlaybackIAOverLay
	description	: Enable PU Playback IA OverLay
	input				: pCameraCode
	input				: pNVRCode
	input				: hWnd 播放窗口句柄
	output			: NA
	return				: 成功-0；失败-1
	*******************************************************************/
	IVS_INT32 EnablePUPlaybackIAOverLay(IVS_ULONG ulPlaybackHandle,
	...
	return				: 成功-0；失败-1
	*******************************************************************/
	IVS_INT32 DisablePUPlaybackIAOverLay(IVS_ULONG ulPlaybackHandle);
	...
	return				: 成功-0；失败-1
	*******************************************************************/
	IVS_INT32 GetPlaybackRtspURL(const IVS_CHAR* pCameraCode, 
...
private:
	...
	*******************************************************************/
	...
	description	:	根据回放句柄获取轨迹叠加对象，没有就创建;
	...
	*******************************************************************/
	...
	/******************************************************************
	function			:	CreateOverLayByPlayHandle
	description	:	Get IAOverLay Object By PlaybackHandle. If not found, create.
	input				:	ulPlayHandle，Playback Handle
	input				:	pCameraID，Camera Code
	input				:	pNVRCode，NVR Code
	input				:	iStartTime，StartTime of the record
	input				:	iEndTime，EndTime of the record
	output			:	NA
	return				:	IAOverLay Object pointer
	*******************************************************************/
	CIAOverLayMgr * CreateOverLayByPlayHandle(IVS_ULONG& ulPlayHandle, 
...
private:
	...
	IVS_TIME_SPAN m_tmTimeSpan;			//录像回放起始止时间
	IVS_TIME_SPAN m_tmOverLayTimeSpan;	//录像轨迹叠加起始止时间，EndTime位录像的结束时间
};
