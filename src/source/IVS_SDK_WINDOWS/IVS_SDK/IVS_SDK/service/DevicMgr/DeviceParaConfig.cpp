...
CDeviceParaConfig::REQUEST_NAME CDeviceParaConfig::m_reqNames[] =
{
	...
	{ CONFIG_CAMERA_SEC_CFG,      (FnSetDevicePara)&CDeviceParaConfig::SetCameraSECCfg,         (FnGetDevicePara)&CDeviceParaConfig::GetCameraSECCfg}
}; 
    ...
    IVS_UINT32 uiBufSize)const
{
	...
	{
		IVS_CAMERA_MULTI_OSD_CFG *pMultODSCfg = static_cast<IVS_CAMERA_MULTI_OSD_CFG *>(const_cast<IVS_VOID *>(pBuffer));
		...
		{
			BP_RUN_LOG_ERR(IVS_PARA_INVALID, "Set DeviceConfig fail", "Buffer Size should more than %d", uiBufSize_S);
                                             ...
                                             IVS_UINT32 uiBufSize)const
{
	...
	eSDK_MEMSET(pBuffer, 0, uiBufSize);
...
IVS_INT32 CDeviceParaConfig::CheckBufferSize(IVS_UINT32 uiConfigType, IVS_UINT32 uiBuffSize)const
{
	...
	IVS_UINT32 uiCheckBufferSize = CDevEnum::GetSizeOfConfigType(uiConfigType);
...

{
	...
	IVS_DEVICE_CFG* pMainDevCfg = static_cast	<IVS_DEVICE_CFG*>(const_cast<IVS_VOID *>(pBuffer));

    CXml xmlTemp;
    IVS_INT32 iRet = CDeviceParaConfigXMLProcess::SetMainParaConfigGetXml(pDomainCode, pDevCode, pMainDevCfg, xmlTemp);
    if (IVS_SUCCEED != iRet)
    {
        BP_RUN_LOG_ERR(iRet, "Set MainDevConfig GetXml fail", "IVS_SUCCEED != iRet");
        return iRet;
    }	
    iRet = CXmlProcess::GetCommSendMgr(xmlTemp, m_pUserMgr, NSS_SET_MAIN_DEV_CFG_REQ, BUILDRET, pDomainCode, pDevCode);
    return iRet;
}
...
IVS_INT32 CDeviceParaConfig::SetMainDevConfigMsg(const IVS_DEVICE_CFG* pMainDevCfg, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode, const char* pszDestModule, const char* pszDeviceCode, enum BP::DOMAIN_TYPE enDomainType)const
{
    ...
    ************************************************************************/
    ...
    int iMultiExchangeKey = oSecurityClient.MultiDomainExchangeKey(NET_ELE_SMU_NSS, m_pUserMgr, pDomainCode, strLinkID, pszDestModule, pszDeviceCode, "", enDomainType);//lint !e64 匹配
    ...
    CXml xmlTemp;
    IVS_INT32 iRet = CDeviceParaConfigXMLProcess::SetMainParaConfigGetXml(pDomainCode,  pDevCode, pMainDevCfg, strDevPWDCipher.c_str(), strDevRegPWDCipher.c_str(), xmlTemp);//lint !e64 匹配
    if (IVS_SUCCEED != iRet)
    {
	...
	//创建要发送的CMD，拼装了NSS消息头
	CCmd *pCmd = CNSSOperator::instance().BuildCmd(strLinkID, NET_ELE_SMU_NSS, NSS_SET_MAIN_DEV_CFG_REQ, pReq, strSecurityTransID);//lint !e64 匹配
...
IVS_INT32 CDeviceParaConfig::SetCameraBriefCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pCameraCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_CAMERA_CFG* pCameraCfg = static_cast<IVS_CAMERA_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetCameraStreamCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode) const 
{
	...
	IVS_CAMERA_STREAM_CFG* pCameraStrCfg = static_cast<IVS_CAMERA_STREAM_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetCameraStreamCfgEventEx(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode) const 
{
	...
	IVS_CAMERA_STREAM_EVENTEX_CFG* pCameraStrCfgEx= static_cast<IVS_CAMERA_STREAM_EVENTEX_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	if (IVS_MAX_STREAM_NUM < pCameraStrCfgEx->uiStreamInfoNum)
	{
		BP_RUN_LOG_ERR(IVS_PARA_INVALID, "SetCameraStreamCfgEventEx fail", "uiStreamInfoNum is more than 8");
		return IVS_PARA_INVALID;
	}
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetCameraBasicImgCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pCameraCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_CAMERA_DISPLAY_CFG* pCameraDisplayCfg = static_cast<IVS_CAMERA_DISPLAY_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml tempXml;
...
IVS_INT32 CDeviceParaConfig::SetCameraPTZCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pCameraCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_PTZ_CFG* pCameraPTZCfg = static_cast<IVS_PTZ_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetAudioCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pCameraCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_AUDIO_CFG* pAudioCfg = static_cast<IVS_AUDIO_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::GetMainDevCfgMsg(IVS_DEVICE_CFG* pMainDevCfg, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode, enum BP::DOMAIN_TYPE enDomainType)const
{
    ...
    ************************************************************************/
    ...
    std::string strLinkID;
	CSDKSecurityClient oSecurityClient;
    int iMultiExchangeKey = oSecurityClient.MultiDomainExchangeKey(NET_ELE_SMU_NSS, m_pUserMgr, pDomainCode, strLinkID, "SCU", pDevCode, "", enDomainType);//lint !e64 匹配
    if (IVS_SUCCEED != iMultiExchangeKey)
    {
	...
	CCmd *pCmd = CNSSOperator::instance().BuildCmd(strLinkID, NET_ELE_SMU_NSS, NSS_GET_DEV_BASIC_INFO_REQ, pReq, strSecurityTransID);//lint !e64 匹配
	CHECK_POINTER(pCmd, IVS_OPERATE_MEMORY_ERROR);
	...
	if (0 != strcmp(pMainDevCfg->cDevPasswd, ""))
	{
		...
		eSDK_MEMSET(pMainDevCfg->cDevPasswd, 0x0, IVS_PWD_LEN);

		if (!CToolsHelp::Memcpy(pMainDevCfg->cDevPasswd, IVS_PWD_LEN, (const void *)strDevNewPWD.c_str(), strDevNewPWD.size()))
		{
	...
	if (0 != strcmp(pMainDevCfg->cDevRegPasswd, ""))
	{
		...
		eSDK_MEMSET(pMainDevCfg->cDevRegPasswd, 0x0, IVS_PWD_LEN);

		if (!CToolsHelp::Memcpy(pMainDevCfg->cDevRegPasswd, IVS_PWD_LEN, (const void *)strDevNewRegPWD.c_str(), strDevNewRegPWD.size()))
		{
...
IVS_INT32 CDeviceParaConfig::GetMultOSDPara(IVS_VOID*& pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode) const
{
	...
	// 将组装好的XML拼装成NSS请求
	CXml xmlRsp;
	iRet = CXmlProcess::GetCommSendMgr(xmlReq, xmlRsp,m_pUserMgr, NSS_GET_MULTY_OSD_PARA_REQ, BUILSTRING, pDomainCode);
	if (IVS_SUCCEED != iRet)
	{
	...
	const IVS_CHAR* pDomainCode)const
{
	...
	const IVS_CAMERA_MULTI_OSD_CFG* pMultODSCfg = static_cast<IVS_CAMERA_MULTI_OSD_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	BP_RUN_LOG_INF("Set Camera MultOSDCfg", "Total: %d, OSDTimeNum: %d, OSDNameNum: %d",
		pMultODSCfg->uiTotal, pMultODSCfg->uiOSDTimeNum, pMultODSCfg->uiOSDNameNum);
	if (IVS_CAMERA_OSD_NUM_MAX < pMultODSCfg->uiOSDTimeNum || IVS_CAMERA_OSD_NUM_MAX < pMultODSCfg->uiOSDTimeNum
		|| IVS_CAMERA_OSD_NUM_MAX < pMultODSCfg->uiTotal)
	{
		BP_RUN_LOG_ERR(IVS_PARA_INVALID, "Set Camera MultOSDCfg", "Num is more than MaxNum");
		return IVS_PARA_INVALID;
	}
	...
	iRet = CXmlProcess::GetCommSendMgr(xmlTemp, m_pUserMgr, NSS_SET_MULTY_OSD_PARA_REQ, BUILDRET, pDomainCode, pDevCode);
	if (IVS_SUCCEED != iRet)
	{
...
IVS_INT32 CDeviceParaConfig::SetAlarmInCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_ALARM_IN_CFG* pAlarmInCfg = static_cast<IVS_ALARM_IN_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetAlarmOutCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_ALARM_OUT_CFG* pAlarmOutCfg = static_cast<IVS_ALARM_OUT_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetVideoMaskCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_VIDEO_MASK* pVideoMask = static_cast<IVS_VIDEO_MASK*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetOsgPara(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_CAMERA_OSD_CFG* pCameraOsgCfg = static_cast<IVS_CAMERA_OSD_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetVideoHideAlarm(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_VIDEO_HIDE_ALARM* pVideoHideAlarm = static_cast<IVS_VIDEO_HIDE_ALARM*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlTemp;
...
IVS_INT32 CDeviceParaConfig::SetMotionDetec(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_MOTION_DETECTION* pMotionDetec = static_cast<IVS_MOTION_DETECTION*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetDevNetConfig(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_DEVICE_NET_CFG* pDevNetCfg = static_cast<IVS_DEVICE_NET_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetDevTimeConfig(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_DEVICE_TIME_CFG* pDevTimeCfg = static_cast<IVS_DEVICE_TIME_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetSerialChannelConfig(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_SERIAL_CHANNEL_CFG* pSerialChannelCfg = static_cast<IVS_SERIAL_CHANNEL_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetCameraImgCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_CAMERA_IMAGING_CFG* pCameraImgCfg = static_cast<IVS_CAMERA_IMAGING_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetCameraExCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_CAMERA_EXTEND_CFG* pCameraExCfg = static_cast<IVS_CAMERA_EXTEND_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetCameraSnapshotCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	...
	IVS_CAMERA_SNAPSHOT_CFG* pCameraSnapshotCfg = static_cast<IVS_CAMERA_SNAPSHOT_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	CXml xmlReq;
...
IVS_INT32 CDeviceParaConfig::SetCameraRecordStreamCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
    ...
    IVS_CAMERA_RECORD_STREAM_CFG* pCameraRecordStream = static_cast<IVS_CAMERA_RECORD_STREAM_CFG*>(const_cast<IVS_VOID *>(pBuffer));
...
IVS_INT32 CDeviceParaConfig::SetCameraFECCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode) const
{
	...
	IVS_CAMERA_FEC_CFG* pCameraFEC = static_cast<IVS_CAMERA_FEC_CFG*>(const_cast<IVS_VOID *>(pBuffer));
	if((pCameraFEC->uiReliableTransmission == RELIABLE_TRANSMISSION_NONE) && (pCameraFEC->uiDataDropPercent == 0))
	{
		;
	}
	else
	{
		std::string tmpStr("12345");
		IVS_CHAR tmpch[3]="";
		(void)itoa((int)pCameraFEC->uiDataDropPercent, tmpch, 10);
		if(string::npos == tmpStr.find(tmpch))
		{
			BP_RUN_LOG_ERR(IVS_DATA_INVALID, "Set Camera FEC Cfg", "DataDropPercent is invalid");
...
// 设置摄像机SEC参数
IVS_INT32 CDeviceParaConfig::SetCameraSECCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode) const
{
	CHECK_POINTER(pDevCode, IVS_OPERATE_MEMORY_ERROR);
	CHECK_POINTER(pDomainCode, IVS_OPERATE_MEMORY_ERROR);
	CHECK_POINTER(pBuffer, IVS_OPERATE_MEMORY_ERROR);
	...
	IVS_INT32 iRet = -1;
	IVS_CAMERA_SEC_CFG* pCameraSEC = static_cast<IVS_CAMERA_SEC_CFG*>(const_cast<IVS_VOID *>(pBuffer));

	if((pCameraSEC->uiReliableTransmission == RELIABLE_TRANSMISSION_NONE) && (pCameraSEC->uiDataDropPercent == 0))
	{
		;
	}
	else
	{
		std::string tmpStr("12345");
		IVS_CHAR tmpch[3]="";
		(void)itoa((int)pCameraSEC->uiDataDropPercent, tmpch, 10);
		if(string::npos == tmpStr.find(tmpch))
		{
			BP_RUN_LOG_ERR(IVS_DATA_INVALID, "Set Camera SEC Cfg", "DataDropPercent is invalid");
			return IVS_DATA_INVALID;
		}
	}
	...
	CXml xmlReq;
	iRet = CDeviceParaConfigXMLProcess::SetCameraSECCfgGetXML(pDevCode, pDomainCode, pCameraSEC, xmlReq);//lint !e838
	if (IVS_SUCCEED != iRet)
	{
		BP_RUN_LOG_ERR(iRet, "Set Camera SEC Cfg", "Get xml failed");
		return iRet;
	}
...
// 查询摄像机SEC参数
IVS_INT32 CDeviceParaConfig::GetCameraSECCfg(IVS_VOID*& pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const
{
	CHECK_POINTER(pDevCode, IVS_OPERATE_MEMORY_ERROR);
	CHECK_POINTER(pDomainCode, IVS_OPERATE_MEMORY_ERROR);
	CHECK_POINTER(pBuffer, IVS_OPERATE_MEMORY_ERROR);
	...
	IVS_CAMERA_SEC_CFG* pCameraSEC = (IVS_CAMERA_SEC_CFG*) pBuffer;
	...
	iRet = CDeviceParaConfigXMLProcess::GetCameraSECCfgParseXML(pCameraSEC, xmlReq);
