...
public:
    ...
    // 设置主设备参数拼接XML,不考虑密钥
    static IVS_INT32 SetMainParaConfigGetXml(const IVS_CHAR* pDomainCode, 
	...
	// 摄像机SEC参数拼装XML
	static IVS_INT32 SetCameraSECCfgGetXML(const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode, const IVS_CAMERA_SEC_CFG* pCameraSEC, CXml &xml);

	// 摄像机SEC参数设置解析XML
	static IVS_INT32 GetCameraSECCfgParseXML(IVS_CAMERA_SEC_CFG* pCameraSEC, CXml &xml);
