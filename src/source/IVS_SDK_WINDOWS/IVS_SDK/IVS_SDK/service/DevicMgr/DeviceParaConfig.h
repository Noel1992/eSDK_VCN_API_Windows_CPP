...
private:
	...
	// 设置摄像机SEC参数
	IVS_INT32 SetCameraSECCfg(const IVS_VOID* pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const;

	// 查询摄像机SEC参数
	IVS_INT32 GetCameraSECCfg(IVS_VOID*& pBuffer, const IVS_CHAR* pDevCode, const IVS_CHAR* pDomainCode)const;
