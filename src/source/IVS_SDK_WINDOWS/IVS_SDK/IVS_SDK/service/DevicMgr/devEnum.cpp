...
const IVS_CHAR chEnCodeModeCHType[][ELEMMAX] = {"", "H264", "MJPEG", "MPEG4", "MPEG2", "AVS", "H265", "SVAC"};
...
const IVS_CHAR chTransType[][ELEMMAX] = {"NONE", "FEC", "ARQ", "HARQ", "SEC"};
const IVS_CHAR chDataFormat[][ELEMMAX] = {"", "G711A", "G711U", "G726", "AAC"};

const IVS_CHAR chCameraType[][ELEMMAX] = {"FIX", "PTZ", "DOME", "FIX_DOME", "BULLET"};
...
IVS_GET_MULT_OSD_BUFSIZE,sizeof(IVS_CAMERA_SEC_CFG)
};
...
const IVS_CHAR* CDevEnum::GetReliableTransTypeCHAR(IVS_INT32 iTransType)
{
	...
	case RELIABLE_TRANSMISSION_FEC:
		result = "FEC";
		break;
	case RELIABLE_TRANSMISSION_SEC:
		result = "SEC";
		break;
