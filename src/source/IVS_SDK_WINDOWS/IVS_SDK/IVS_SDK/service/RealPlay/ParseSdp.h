...
#define SDP_VIDEO_H265_TYPE          "H265"
#define SDP_VIDEO_SVAC_TYPE          "SVAC"
...
typedef struct _stMEDIA_KEY_INFO
{
	...
	IVS_UINT32 uAudioSampleRate;     //sample rate of audio
...
/***************************************************************************
 ...
 返 回 值 : IVS_SUCCEED-成功           其他-失败
***************************************************************************/
int parseApplications(const char* pAppliMsg, IVS_ULONG* pPort);
