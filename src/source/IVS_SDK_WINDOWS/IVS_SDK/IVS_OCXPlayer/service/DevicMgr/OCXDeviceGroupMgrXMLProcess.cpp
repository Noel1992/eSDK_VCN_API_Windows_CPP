...
IVS_INT32 COCXDeviceGroupMgrXMLProcess::AddDeviceGroupParseXML(IVS_DEV_GROUP* pGroupInfo,CXml &xml)
{
	...
	// 域编码
	GET_ELEM_VALUE_CHAR("DomainCode", pElemValue, pGroupInfo->cDomainCode, IVS_DOMAIN_CODE_LEN, xml);	//lint !e838
	// 设备组名
...
IVS_INT32 COCXDeviceGroupMgrXMLProcess::DeleteDeviceGroupParseXML(IVS_DEV_GROUP &stDevGroup, CXml &reqXml)
{
	...
	// 域编码
	GET_ELEM_VALUE_CHAR("DomainCode", pTemp, stDevGroup.cDomainCode, IVS_DOMAIN_CODE_LEN, reqXml);	//lint !e838
	// 设备组ID
...
IVS_INT32 COCXDeviceGroupMgrXMLProcess::GetDeviceGroupParseXML(IVS_CHAR* pDomainCode, IVS_CHAR* pDevGroupCode, CXml& xmlReq)
{
    ...
    GET_ELEM_VALUE_CHAR("DomainCode", szElemValue, pDomainCode, IVS_DOMAIN_CODE_LEN, xmlReq);	//lint !e838
...
IVS_INT32 COCXDeviceGroupMgrXMLProcess::ModifyDeviceGroupNamePraseXML(IVS_DEV_GROUP* pDevGroupInfo, CXml &xml)
{
	...
	const IVS_CHAR *pTemp = NULL;    
	// 设备组名    
	GET_ELEM_VALUE_CHAR("GroupName", pTemp, pDevGroupInfo->cName, IVS_NAME_LEN, xml);	//lint !e838
	// 设备组ID
	...
	CXml& xmlReq)
{
	...
	const IVS_CHAR *pTemp = NULL;
	// 设备组名    
	GET_ELEM_VALUE_CHAR("DomainCode", pTemp, pTargetDomainCode, IVS_DOMAIN_CODE_LEN, xmlReq);	//lint !e838
	// 移动到的设备组ID    
	...
	if (xmlReq.FindElemEx("Content/DevList"))
	{
		do 
		{
			...
			GET_ELEM_VALUE_CHAR("DevDomainCode", pTemp, pGroupCameraList[uiIndex].cCameraDomainCode, IVS_DOMAIN_CODE_LEN, xmlReq);
...
IVS_INT32 COCXDeviceGroupMgrXMLProcess::SetDevGroupRemarkParseXML(IVS_CHAR* pDomainCode, IVS_UINT32 &uiDevGroupID, IVS_CHAR* pDevGroupRemark, CXml &xml)
{
	...
	const IVS_CHAR* pTemp = NULL;
	GET_ELEM_VALUE_CHAR("DomainCode", pTemp, pDomainCode, IVS_DOMAIN_CODE_LEN, xml);	//lint !e838
