...
public:
	...
	IVS_INT32 SetCameraStreamCfgEventExParseXML(IVS_VOID*& pBuffer, CXml &xml)const;

	// 设置摄像机多行OSD信息设置XML
	IVS_INT32 SetCameraMutlOSDCfgParseXML(IVS_VOID*& pBuffer, CXml &xml)const;

	//  获取摄像机多行OSD信息参数XML
	IVS_INT32 GetCameraMutlOSDCfgGetXML(IVS_VOID* &pBuffer, const IVS_CHAR* pDevCode, CXml &xml)const;
