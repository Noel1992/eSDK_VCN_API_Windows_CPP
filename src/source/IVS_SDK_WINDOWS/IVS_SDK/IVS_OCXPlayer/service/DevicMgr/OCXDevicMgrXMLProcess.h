...
public:
	...
	// 获取摄像机设备列表扩展拼接xml
	static IVS_INT32 GetCamerasExGetXml( IVS_CAMERA_BRIEF_INFO_LIST_EX* pRspDeviceList,
		CXml &rspXml);

	//获取影子摄像机设备列表拼接xml
	static IVS_INT32 GetshadowCamerasGetXml( IVS_SHADOW_CAMERA_BRIEF_INFO_LIST* pRspDeviceList,
		CXml &rspXml);
