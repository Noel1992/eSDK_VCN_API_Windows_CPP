...
IVS_INT32 COCXLogMgrXMLProcess::GetResOperationLogXML(IVS_OPERATION_LOG_LIST* pOperationLogList, CXml& xmlRes)
{
	...
	while(i < uiRestltNum)
	{
		...
		eSDK_MEMSET(szAccount, 0x0, IVS_NAME_LEN + 1);
		...
		eSDK_MEMSET(szClientIP, 0x0, IVS_IP_LEN + 1);
		...
		eSDK_MEMSET(szServiceCode, 0x0, IVS_DESCRIBE_LEN + 1);
		...
		eSDK_MEMSET(szModuleType, 0x0, IVS_DESCRIBE_LEN + 1);
		...
		eSDK_MEMSET(szModuleCode, 0x0, IVS_DEV_CODE_LEN + 1);
		...
		eSDK_MEMSET(szOperationCode, 0x0, IVS_DEV_CODE_LEN + 1);
		...
		eSDK_MEMSET(szOperationObjectCode, 0x0, IVS_DESCRIBE_LEN + 1);
		...
		eSDK_MEMSET(szOccurTime, 0x0, IVS_TIME_LEN + 1);
		...
		eSDK_MEMSET(szErrorCode, 0x0, IVS_DESCRIBE_LEN + 1);
		...
		eSDK_MEMSET(szAdditionalInfo, 0x0, IVS_DESCRIBE_LEN + 1);
