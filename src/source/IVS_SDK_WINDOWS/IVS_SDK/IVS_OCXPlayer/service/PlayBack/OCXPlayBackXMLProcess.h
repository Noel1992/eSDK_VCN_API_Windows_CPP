...
public:
	...
	char			NVRCode[IVS_NVR_CODE_LEN + 1];
	...
	CRecordSnap ()
 	{
		...
		eSDK_MEMSET(CamCode, 0, sizeof(CamCode));
		eSDK_MEMSET(NvrCode, 0, sizeof(NvrCode));
		eSDK_MEMSET(MbuDomain, 0, sizeof(MbuDomain));
		eSDK_MEMSET(FileName, 0, sizeof(FileName));
		eSDK_MEMSET(FilePath, 0, sizeof(FilePath)); 
		eSDK_MEMSET(&RecTimeSpan,0,sizeof(IVS_TIME_SPAN));
	}//lint !e1401
	~CRecordSnap(){};
