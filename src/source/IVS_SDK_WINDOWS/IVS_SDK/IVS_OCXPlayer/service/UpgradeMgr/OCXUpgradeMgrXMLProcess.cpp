...
IVS_INT32 COCXUpgradeMgrXMLProcess::GetCUVersionRspXML(IVS_UPGRADE_INFO& stUpgradeInfo, IVS_INT32 iRetCord,CXml& xmlRsp)
{
    ...
    eSDK_STRNCPY(cSetupFileMd5, sizeof(cSetupFileMd5), stUpgradeInfo.cSetupFileMd5, IVS_MD5_LEN);
    ...
    eSDK_STRNCPY(cUrl, sizeof(cUrl), stUpgradeInfo.cHttpURL, IVS_URL_LEN);
