...
CSkinMgr::~CSkinMgr(void)
{
    try
    {
        m_MapBarPngPicture.clear();
        m_MapBarBMPicture.clear();
		IVS_DELETE(m_imagePaneBKG);
		m_imagePaneBKG = NULL;
		IVS_DELETE(m_imagePaneALARM);
		m_imagePaneALARM = NULL;
		IVS_DELETE(m_imageBarBKG);
		m_imageBarBKG = NULL;
		IVS_DELETE(m_imageTitleBarBKG);
		m_imageTitleBarBKG = NULL;
		IVS_DELETE(m_imageTVWallOnlineStatusBarBKG);
		m_imageTVWallOnlineStatusBarBKG = NULL;
		IVS_DELETE(m_imageTVWallOfflineStatusBarBKG);
		m_imageTVWallOfflineStatusBarBKG = NULL;
		IVS_DELETE(m_imageWhitePaneBKG);
		m_imageWhitePaneBKG = NULL;
		IVS_DELETE(m_imageWhitePaneALARM);
		m_imageWhitePaneALARM = NULL;
		IVS_DELETE(m_imageWhiteBarBKG);
		m_imageWhiteBarBKG = NULL;
		IVS_DELETE(m_imageWhiteTitleBarBKG);
		m_imageWhiteTitleBarBKG = NULL;
		IVS_DELETE(m_imageWhiteTVWallOnlineStatusBarBKG);
		m_imageWhiteTVWallOnlineStatusBarBKG = NULL;
		IVS_DELETE(m_imageWhiteTVWallOfflineStatusBarBKG);
...
IVS_ULONG CSkinMgr::SetSkin()
{
	...
	wstr = CTranslucentUtility::ttowc(strPicturePath.c_str());	//lint !e838
	...
	wstr = CTranslucentUtility::ttowc(strTVWallOnlinePath.c_str());	//lint !e838
    ...
    wstr = CTranslucentUtility::ttowc(strTVWallOfflinePath.c_str());	//lint !e838
                                    ...
                                    std::string &strPathClicked )
{
	...
	wstr = CTranslucentUtility::ttowc(strPathGray.c_str());	//lint !e838
	...
	wstr = CTranslucentUtility::ttowc(strPathNormal.c_str());	//lint !e838
	...
	wstr = CTranslucentUtility::ttowc(strPathClicked.c_str());	//lint !e838
...
{
	m_iSkinID = iSkinID;
	IVS_ULONG ulRet = m_SkinXML.SetSkin(iSkinID);
	return ulRet;
}
