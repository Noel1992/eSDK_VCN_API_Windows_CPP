...
private:
	...
	IVS_INT32 SendMessageReqXML(IVS_INT32 iSessionID, IA_REQ_PARAM &IAReqParam, const IVS_CHAR *pTransID)const;
	IVS_INT32 SendMessageStopXML(IVS_INT32 iSessionID, IVS_ULONG ulRequestID, IVS_ULONG ulRuleType, IVS_ULONG ulQueryType, const IVS_CHAR *CameraID, const IVS_CHAR *pTransID)const;
