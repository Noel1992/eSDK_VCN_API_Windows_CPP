    ...
    , m_IsCreate(false)
{
	...
	eSDK_MEMSET(&m_blend,0x0,sizeof(BLENDFUNCTION));
...
void CTranslucentDialog::UpdateView()
{
    ...
    RECT rcWindow;
    eSDK_MEMSET(&rcWindow, 0, sizeof(rcWindow));
	...
	{
		SecureZeroMemory(pvBits, static_cast<unsigned int >(sizeWindow.cx * 4 * sizeWindow.cy));
