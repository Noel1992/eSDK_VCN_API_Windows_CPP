  ...
  *******************************************************************/
  ...
  /******************************************************************
    ...
    **************************************************************************/
	...
	/*****************************************************************
	* name       : IVS_SDK_SetCameraBackupConfig
	* description: 设置摄像机备份参数
	* input      : iSessionID 登录成功后的会话ID
				   pBackupXml 录像备份参数XML
	* output     : NA
	* return     : 成功返回IVS_SUCCESSED，失败返回错误码
	* remark     : NA
	*****************************************************************/
	IVS_SDK_API IVS_INT32 __SDK_CALL IVS_SDK_SetCameraBackupConfig(IVS_INT32 iSessionID, 
		const IVS_CHAR* pBackupXml);

	/*****************************************************************
	* name       : IVS_SDK_GetCameraBackupConfig
	* description: 获取摄像机备份参数
	* input      : iSessionID 登录成功后的会话ID
				   pCameraCode 摄像机编码
	* output     : pBackConfigXml 备份参数xml
	* return     : 成功返回IVS_SUCCESSED，失败返回错误码
	* remark     : NA
	*****************************************************************/
	IVS_SDK_API IVS_INT32 __SDK_CALL IVS_SDK_GetCameraBackupConfig(IVS_INT32 iSessionID, 
		const IVS_CHAR* pCameraCode, 
		IVS_CHAR** pBackConfigXml);
