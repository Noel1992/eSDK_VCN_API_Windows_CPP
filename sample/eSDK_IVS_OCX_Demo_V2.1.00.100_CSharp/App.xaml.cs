    ...
    public partial class App : System.Windows.Application
    {
        ...
        private void LoadLanguage()
        {
            ...
            try
            {
                ...
                langRdList.Add(
                System.Windows.Application.LoadComponent(
                new Uri("/Resources/Style/" + "ButtonStyle.xaml", UriKind.Relative)) as ResourceDictionary);

                langRdList.Add(
                System.Windows.Application.LoadComponent(
                new Uri("/Resources/Style/" + "TextBoxStyle.xaml", UriKind.Relative)) as ResourceDictionary);

                langRdList.Add(
                System.Windows.Application.LoadComponent(
                new Uri("/Resources/ResultCode/" + "CUResultCode.xaml", UriKind.Relative)) as ResourceDictionary);

                langRdList.Add(
                System.Windows.Application.LoadComponent(
                new Uri("/Resources/ResultCode/" + "OCXResultCode.xaml", UriKind.Relative)) as ResourceDictionary);
            }
            catch (Exception ex)
            {
